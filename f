...
top.Parent = main
top.Active = true
top.BackgroundColor3 = Color3.fromRGB(255, 238, 56)
...
back.Name = "back"
back.Parent = top
back.BackgroundColor3 = Color3.fromRGB(255, 238, 56)
...
slock.MouseButton1Click:connect(function()
	if slockk then 
		queue.Text = "SUPORT DISCORD#"
		slockk = false
	else
		queue.Text = "SUPPORT #DISCORD"
		slockk = true
	end
end)
...
credits.Text = "SCRIPT ATTACKER REMADE AGAIN CR4KADY#2207"
...
queue.Text = "AZER CRACK"
queue.TextColor3 = Color3.fromRGB(57, 255, 57)
...
destroytool.TextureId = "http://www.roblox.com/asset/?id=11582978991"
...
Players.LocalPlayer.CharacterAdded:connect(function()
	...
	destroytool.RequiresHandle = false
	destroytool.Name = "Delete"
	destroytool.ToolTip = "FACK HARKED"
	destroytool.TextureId = "http://www.roblox.com/asset/?id=11582978991"
	destroytool.CanBeDropped = false
	destroytool.Equipped:connect(function()
		equipped = true
